...
from app.utils.web_search import search_espe_website  # Cambiado desde web_scraper.py a web_search.py
...
def handle_question(user_question):
    ...
    # Si no se encontró en FAQ, buscar en el sitio web
    web_response = search_espe_website(user_question)
    if web_response:
        return web_response

    # Si no se encuentra en FAQ ni en el sitio web
